...
- [task-5-inbox-dedup/00-index.md](plans/task-5-inbox-dedup/00-index.md)：Task 5 Inbox 与 Telegram Webhook 去重独立详细计划唯一入口；READY v1.3 / WAITING_EXTERNAL_REVIEW，40 个连续步骤、T5C01～T5C50、七个 canonical 未来目标；代码 NOT_STARTED，第 10/48 步 NOT_STARTED。
