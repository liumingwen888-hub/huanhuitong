...
- [task-6-outbox-worker/00-index.md](plans/task-6-outbox-worker/00-index.md)：Task 6 Outbox、持久任务与安全 Worker 独立详细计划唯一入口；READY v1.0 / WAITING_EXTERNAL_REVIEW，T6C01–T6C28 测试合同、冻结 Create 8/Modify 2/Delete 0；代码 NOT_STARTED，第 12/48 步 NOT_STARTED。
