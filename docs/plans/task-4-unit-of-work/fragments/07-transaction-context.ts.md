# TransactionContext source canonical fragment
...
- Reconstructed target: `apps/platform/src/infrastructure/database/transaction-context.ts`
- Assembly sequence: 1 of 1
- Responsibility: Complete revocable TransactionContext, QueryCreator lease and protected executeSql lifecycle.
- Segment bytes: 5511
- Segment lines: 220
- Segment SHA-256: `CA3B9B8959FF6786652A4828E85FEDCE776C961759EC57FDBE3E2649C29EDE1C`
- Full target bytes: 5511
- Full target SHA-256: `CA3B9B8959FF6786652A4828E85FEDCE776C961759EC57FDBE3E2649C29EDE1C`

<!-- XHT-CANONICAL-BEGIN target="apps/platform/src/infrastructure/database/transaction-context.ts" sequence="1" -->
```ts
...
```
<!-- XHT-CANONICAL-END target="apps/platform/src/infrastructure/database/transaction-context.ts" sequence="1" -->
