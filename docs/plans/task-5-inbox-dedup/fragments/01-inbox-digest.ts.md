# Canonical fragment: packages/contracts/src/inbox-digest.ts

[返回 fragments 索引](00-index.md)

<!-- XHT-T5-CANONICAL-BEGIN target="packages/contracts/src/inbox-digest.ts" sequence="1" -->
```ts
...
```
<!-- XHT-T5-CANONICAL-END target="packages/contracts/src/inbox-digest.ts" sequence="1" -->
