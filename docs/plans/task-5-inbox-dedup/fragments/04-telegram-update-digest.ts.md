# Canonical fragment: apps/platform/src/modules/reliability/inbox/telegram-update-digest.ts

[返回 fragments 索引](00-index.md)

<!-- XHT-T5-CANONICAL-BEGIN target="apps/platform/src/modules/reliability/inbox/telegram-update-digest.ts" sequence="1" -->
```ts
...
```
<!-- XHT-T5-CANONICAL-END target="apps/platform/src/modules/reliability/inbox/telegram-update-digest.ts" sequence="1" -->
