# Canonical fragment: apps/platform/test/unit/telegram-update-digest.spec.ts

[返回 fragments 索引](00-index.md)

<!-- XHT-T5-CANONICAL-BEGIN target="apps/platform/test/unit/telegram-update-digest.spec.ts" sequence="1" -->
```ts
import type {
  InboxDigestKey,
...
```
<!-- XHT-T5-CANONICAL-END target="apps/platform/test/unit/telegram-update-digest.spec.ts" sequence="1" -->
